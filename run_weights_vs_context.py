...
def prompt_patterns(question: str, patterns_text: str) -> str:
    return f"{SYSTEM}\n\nНиже reference patterns нашей компании:\n{patterns_text}\n\nВопрос архитектора:\n{question}\n\nОтвет:"
...
def main():
    ...
    ap.add_argument("--output", default="results_weights_vs_context.md")
    ...
    for label, model, tok, prompt in variants:
        ...
        rows.append({"label": label, "answer": answer, "runtime_sec": round(runtime, 1), "score": score, "checks": checks})

    md = []
    md.append("# Honest Test — Weights vs Context")
    md.append("")
    md.append("## Question")
    md.append(question)
    md.append("")
    ...
    md.append("")
    md.append("Core question: does E beat D? If yes, LoRA adds value beyond retrieval.")
